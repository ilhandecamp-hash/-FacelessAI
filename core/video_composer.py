...
# Dimensions de sortie selon l'orientation choisie.
...
def compose_video(
    ...
    # petite garde des sous-titres proportionnés plutôt qu'écrasants.
    font_size = 70 if orientation == "portrait" else 56
